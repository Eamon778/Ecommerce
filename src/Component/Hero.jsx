            ...
            <section className="bg-[#F2F0F1]">
                <div className="md:container mx-auto px-2 md:px-0 flex flex-col md:flex-row justify-around items-center">
                    <div className="flex-1 pt-6 md:pt-0">
                        <h3 className='font-bold text-4xl  lg:text-7xl'>FIND CLOTHES <br /> THAT MATCHES <br /> YOUR STYLE</h3>
                        ...
                        <div className='flex flex-col md:flex-row gap-4 justify-center md:justify-normal items-center'>
